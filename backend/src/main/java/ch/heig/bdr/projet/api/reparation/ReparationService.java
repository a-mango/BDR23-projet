...
public class ReparationService {
    ...
    Reparation getReparationById(String id){
    ...
    ArrayList<Reparation> getReparations(){
    ...
    void updateReparation(String id, Reparation updatedReparation){
    ...
    void deleteReparation(String id){
