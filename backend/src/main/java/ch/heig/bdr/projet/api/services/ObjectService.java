...
public class ObjectService {
    ...
    public Object getObjectById(String id) {
        ...
        try (PreparedStatement pstmt = conn.prepareStatement(query)) {
            ...
            try (ResultSet rs = pstmt.executeQuery()) {
                if (rs.next()) {
                    return new Object(rs.getInt("object_id"), rs.getString("name"), rs.getString("fault_desc"), rs.getString("remark"), rs.getString("serial_no"), Location.valueOf(rs.getString("location")), new Brand(rs.getString("brand")), new Category(rs.getString("category")), rs.getInt("customer_id"));
                } else {
                    return null;
                }
            }
    ...
    public ArrayList<Object> getObjects() {
        ...
        try (Statement statement = conn.createStatement(); ResultSet rs = statement.executeQuery(query)) {
            ...
            while (rs.next()) {
                objects.add(new Object(rs.getInt("object_id"), rs.getString("name"), rs.getString("fault_desc"), rs.getString("remark"), rs.getString("serial_no"), Location.valueOf(rs.getString("location")), new Brand(rs.getString("brand")), new Category(rs.getString("category")), rs.getInt("customer_id")));
            }
            return objects;
        } catch (SQLException e) {
            System.out.println(e.getMessage());
